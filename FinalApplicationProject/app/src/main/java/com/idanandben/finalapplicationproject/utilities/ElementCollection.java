...
public class ElementCollection {
    ...
    private void createElementMap() {
        ...
        elementMap.put(88, new Element(88, "Ra", "Radium", 7, 2, 226, 4));//fffffffffffffffffffffffff
        ...
        elementMap.put(111, new Element(111, "Rg", "Roentgenium", 7, 11, 280, 8));
        elementMap.put(112, new Element(112, "Cn", "Copernicium", 7, 12, 285, 8));
